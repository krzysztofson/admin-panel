  ...
  >
    ...
    >
      <div class="flex justify-between">
        <div>
          <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">Miesięczny cel</h3>
          <p class="mt-1 text-gray-500 text-theme-sm dark:text-gray-400">
            Cel, który ustawiłeś na każdy miesiąc
          </p>
        </div>
        <div>
      ...
      <p class="mx-auto mt-1.5 w-full max-w-[380px] text-center text-sm text-gray-500 sm:text-base">
        10% wzrost w stosunku do poprzedniego pełnego miesiąca rozliczeniowego
      </p>
    </div>
